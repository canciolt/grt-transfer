    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('A', 'Abierta'), ('C', 'Cancelada'), ('P', 'Pagada')], default='A', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('moneda', models.CharField(choices=[('MXN', 'Pesos'), ('USD', 'Dollar')], max_length=3)),
