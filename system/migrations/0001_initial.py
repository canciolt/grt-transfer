# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-10-12 02:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('pais', models.CharField(choices=[('US', 'United States'), ('MX', 'Mexico')], max_length=20, verbose_name='pa\xeds')),
                ...
                ('rfc', models.CharField(blank=True, help_text='Registro Federal de Contribuyentes', max_length=13, validators=[django.core.validators.RegexValidator(message='C\xf3digo RFC invalido', regex='^([A-Z\xd1&]{3,4}) ?(?:- ?)?(\\d{2}(?:0[1-9]|1[0-2])(?:0[1-9]|[12]\\d|3[01])) ?(?:- ?)?([A-Z\\d]{2})([A\\d])$')], verbose_name='RFC')),
                ...
                ('tax', models.CharField(blank=True, max_length=45, verbose_name='tax')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('camion_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comb_camion', to='system.Camion', verbose_name='camion')),
            ],
        ),
        migrations.CreateModel(
