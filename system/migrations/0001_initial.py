# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-10-22 18:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('A', 'Abierta'), ('C', 'Cerrada'), ('P', 'Pagada')], default='A', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pasaporte', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message='Numero de pasaporte invalido', regex='^(\\d{2})(\\d{2})(\\d{2})\\d{5}$')], verbose_name='pasaporte')),
